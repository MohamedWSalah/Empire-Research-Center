...
<!-- *********************** -->
<!-- *********************** -->
<!-- Multiple Style Sheets Exists for management & for avoiding complications in the design -->
<!-- Multiple JavaScript Sheets Exists for management and for avoiding complications in loading the functions to their desired locations i,e window.load function-->
...
<body>
    <!-- Setting Website Background And an Un-OrderList Navigation Bar - Amr ahmed Abd El Rahamn- 162697 -->
    <div class="BackGroundTest">
        <div class="row">
            <div class="logo">
                <img id="LogoAnim" src="../logo/logo1.png" onmouseover="SetNewImage()" onmouseout="SetOldImage()" alt="" />
                <ul class="main-nav">
            ...
            <!-- Java Script Moving Cursor Array - Amr ahmed Abd El Rahamn- 162697 -->
            <div class="MiddleText">
                <h1>Empire Offers
                    <span class="txt-rotate" data-period="2000" data-rotate='[ "Researches.", "Feedback.", "Partnership.", "Community", "Online Platform" ]'></span>
                </h1>
                <hr>
                <div class="button">
                    <a href="Signup.php" class="btn btn-one"> Register</a>
                    <a href="About.php" class="btn btn-two"> Explore More</a>
                </div>
            </div>
        </div>
    </div>
    <!--Professors Area- Amr ahmed Abd El Rahamn- 162697 -->
    <div class="image-container">
        <div class="text">Unique Experience</div>
    </div>
    <div class="ProfessorsArea">
        <div class="column">
            <div class="card">
                <img src="../images/member2.jpg" alt="Jane" style="width:100%">
                <div class="container">
                    <h2 class="ProfessorsNames">Nancy Tarek</h2>
                    <p class="title">CEO &amp; Founder</p>
                    <p class="title">The joint PhD program in computational biology program</p>
                    <p class="title">geek3mr@gmail.com</p>
        ...
        <div class="column">
            <div class="card">
                <img src="../images/member5.jpg" alt="Mike" style="width:100%">
                <div class="container">
                    <h2 class="ProfessorsNames">Yassine El Tohami</h2>
                    <p class="title">Neurosurgeon</p>
                    <p class="title">Interdisciplinary Biomedical (ISB) Graduate Program </p>
                    <p class="title">geek3mr@gmail.com</p>
                    <p><button class="button1">Contact</button></p>
                </div>
            </div>
        ...
        <div class="column">
            <div class="card">
                <img src="../images/member3.jpg" alt="John" style="width:100%">
                <div class="container">
                    <h2 class="ProfessorsNames">Abdalla Megahid </h2>
                    <p class="title">Diagnostician</p>
                    <p class="title">The Integrative Systems Biology (ISB) graduate program </p>
                    <p class="title">geek3mr@gmail.com</p>
                    <p><button class="button1">Contact</button></p>
                </div>
            </div>
        ...
        <div class="column">
            <div class="card">
                <img src="../images/member4.jpg" alt="John" style="width:100%">
                <div class="container">
                    <h2 class="ProfessorsNames">Sara Khalid</h2>
                    <p class="title">Anesthesiologist.</p>
                    <p class="title">Molecular Biophysics and Structural Biology program</p>
                    <p class="title">geek3mr@gmail.com</p>
                    <p><button class="button1">Contact</button></p>
                </div>
            </div>
        ...
        <div class="contact_us">
            <div class="contact_us_fon">
                <div class="contact_us_left">
                    ...
                    <div class="contact_us_small_text adress"> 22, banafseg 1, 1st settlement, New Cairo - Egypt</div>
