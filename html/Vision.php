...
<body>
    <div class="BackGroundTest">
        <div class="row">
            ...
            <div id="slideshow">
                <div>
                    <img alt="" src="../images/slide-four.jpg" height="400" width="900">
                </div>
                <div>
                    <img alt="" src="../images/Clinic2.jpg" height="400" width="900">
                </div>
                <div>
                    <img alt="" src="../images/Clinic1.jpg" height="400" width="900">
                </div>
            </div>
        </div>
    </div>
