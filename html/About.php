...
<head>
    ...
    <link href="../Includes/css/AboutStyle.css" rel="stylesheet" type="text/css">
    <!--The beginning of query cdn -->
    <script src="../Includes/js/jquery-1.3.1.min.js"></script>
    <script src="../Includes/js/jquery.easing.1.3.js"></script>
    <script src="../Includes/js/ScriptsAbout.js"></script>
